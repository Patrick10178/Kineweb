...
<body id="body">
    ...
    <main>
        <div class="contenedor__todo">
                ...
                <!-- Boton para registrar nuevo paciente-->
                    <div class="caja__trasera-register">
                        <button id="btn__registrarse">Nuevo Paciente</button>
                    ...
                    <form action="registro.php" method="POST" enctype="multipart/form-data" class="formulario__register" name="form1">
                        ...
                        <div class="contenedor__radio">
                            <div class="radio_container">
                                <input type="radio" id="masculino" name="sex" value="m" required>
                                <label for="masculino">Masculino</label>
                            </div>
                            <div class="radio_container">
                                <input type="radio" id="femenino" name="sex" value="f" required>
